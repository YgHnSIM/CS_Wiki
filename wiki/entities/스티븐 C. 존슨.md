...
review:
  mode: attested
  revision: sha256:605a2b05cbac7703c28a3c772f0502deb333092bdc2055a2a82ff81a2d5175e2
...
[[스티븐 C. 존슨]]은 C와 Unix 도구 생태계의 이식성에 기여한 Bell Labs 연구자다. 이 위키에서는 [[Portability of C Programs and the UNIX System]]의 공저자이자 pcc와 lint 같은 도구 흐름을 통해 [[C 언어]] 프로그램의 [[이식성]]과 인터페이스 점검을 강화한 인물로 다룬다.

## 위키에서의 의미

Johnson의 기여는 C와 Unix의 성공이 언어 문법만으로 이루어진 것이 아니라 컴파일러·정적 검사·전처리기·기계별 선언 분리와 같은 도구 체계와 함께 이루어졌음을 보여준다.
