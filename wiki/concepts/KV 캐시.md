...
sources: ["Orca - A Distributed Serving System for Transformer-Based Generative Models", "Efficient Memory Management for Large Language Model Serving with PagedAttention"]
status: active
...
- [[자기 주의]] — 캐시에 저장하는 키와 값이 새 토큰의 문맥 참조에 쓰이는 원래 연산이다.
