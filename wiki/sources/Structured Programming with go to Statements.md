...
[[Structured Programming with go to Statements]]는 [[도널드 커누스]]가 1974년에 발표한 논문이다. 이 글은 Dijkstra 이후의 `goto` 논쟁을 정리하면서, 신뢰할 수 있고 잘 구조화된 프로그램과 효율적인 프로그램 사이의 긴장을 여러 사례로 검토한다.
