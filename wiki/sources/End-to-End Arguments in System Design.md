...
논문의 대표 사례는 두 시스템 사이의 신중한 파일 전송이다. 패킷이 손상되지 않고 네트워크를 통과했더라도, 양 끝의 운영체제·메모리·저장 장치·응용 처리에서 오류가 생길 수 있다. 따라서 네트워크의 전달 확인은 “목적지 응용이 요청한 작업을 올바르게 수행했다”는 확인과 다르다.
