...
Backus는 1954년 이전에는 대부분의 프로그래밍이 기계어 또는 어셈블리 언어로 이루어졌고, 프로그래머들이 효율적인 프로그램을 만드는 일을 복잡하고 창의적인 기술로 여겼다고 회고한다. 이 배경에서 Fortran의 목표는 단순히 새 문법을 만드는 것이 아니라, 사람이 기계의 결함과 세부 제약을 직접 떠안던 상황을 바꾸는 것이었다.
