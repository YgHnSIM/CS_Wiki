...
[[GHG Protocol Product Life Cycle Accounting and Reporting Standard]]은 제품의 생애주기 전반에서 발생하는 온실가스 배출을 측정·보고하기 위한 GHG Protocol의 2011년 표준이다. 이 표준은 제품 자체의 사용 단계만 떼어 보지 않고 원료, 제조, 운송, 사용, 폐기 등 수명 주기 단계를 회계 경계 안에서 정의하도록 요구한다.
