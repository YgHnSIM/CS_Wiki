...
[[Cambridge Computer Laboratory - The History of the Computer Lab]]는 케임브리지 대학 컴퓨터 연구소가 정리한 기관 역사 자료다. 이 위키에서는 [[EDSAC]] I의 운영 시기와 후속 EDSAC II의 발전을 구분하고, [[마이크로프로그래밍]]이 EDSAC I의 응용 소프트웨어 계층이 아니라 Wilkes의 후속 제어부 연구에서 실현된 계보임을 확인하는 근거로 삼는다.
