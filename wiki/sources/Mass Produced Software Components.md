...
McIlroy의 핵심 문제의식은 소프트웨어 생산이 하드웨어나 기계 부품 산업처럼 표준 부품·제품군·카탈로그·품질 보증을 갖추지 못했다는 데 있다. 소프트웨어는 복제가 쉬우므로 "대량 생산"의 의미가 단순한 복제일 수 없다. 여기서 대량 생산은 같은 기능을 여러 정밀도·견고성·일반성·시간-공간 성능 조건에 맞춰 제공하는 제품군 생산을 뜻한다.
