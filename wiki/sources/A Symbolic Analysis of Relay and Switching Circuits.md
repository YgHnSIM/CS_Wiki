...
[[A Symbolic Analysis of Relay and Switching Circuits]]는 [[클로드 섀넌]]이 MIT 석사 논문을 바탕으로 1938년에 발표한 논문이다. 이 문헌은 [[릴레이 회로]]와 스위치의 열림·닫힘 상태를 기호 변수로 표현하고, 그 조합을 [[불 대수]]와 같은 방식으로 조작할 수 있음을 보여 주었다.
