...
[[MLPerf Training Benchmark]]은 Peter Mattson 등 연구진이 2020년에 발표한 기계학습 시스템 학습 벤치마크 논문이다. 이 벤치마크는 서로 다른 하드웨어와 소프트웨어 스택을 비교할 때 단순 처리량이 아니라, 규정된 과업 품질 목표에 도달하는 데 걸린 시간을 성능 결과로 삼는다.
