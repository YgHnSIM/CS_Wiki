...
연구는 하드웨어·소프트웨어·네트워크·운영자를 서비스 구성요소로 보고, 사용자에게 품질 저하가 나타난 사건을 서비스 장애로 구분한다. 중복은 하드웨어·소프트웨어·네트워크 구성요소의 일부 장애를 가릴 수 있었지만, 잘못된 설정·운영 절차는 중복된 구성요소에 같은 오류를 적용할 수 있어 덜 은폐되었다는 결과를 보고한다.
