...
논문은 175B 매개변수 모델을 약 네 GPU 시간에 양자화하고, 평가 조건에서 3–4비트 가중치로도 원 모델 대비 정확도가 소폭만 저하된다고 보고했다. 또한 압축된 가중치 전용 행렬–벡터 커널을 사용해 FP16 대비 A100에서 약 3.25배, A6000에서 약 4.5배의 종단 추론 가속을 보고했다.
